...
Hit sphere_hit(Ray ray, Sphere sphere){
    ...
    float c = dot(ray_offset_origin, ray_offset_origin) - sphere.radius * sphere.radius;
    ...
    for (int ray_num = 0; ray_num < num_rays; ray_num++){
        ...
        for (int bounce = 0; bounce < num_bounces; bounce++) {
            ...
            if (closestHit.hit) {
                ...
                bool is_specular = check_specular(closestHit.material.reflectivity, rng);
                if (is_specular) {
